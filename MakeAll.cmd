...
@set SWVER=_v59
@del /Q "ATC%SWVER%.bin"
make -s -j PROJECT_NAME=ATC%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_LYWSD03MMC"
...
@del /Q "BTH%SWVER%.bin"
make -s -j PROJECT_NAME=BTH%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_MJWSD05MMC"
@if not exist "BTH%SWVER%.bin" goto :error
@del /Q "BTE%SWVER%.bin"
make -s -j PROJECT_NAME=BTE%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_MJWSD05MMC_EN"
@if not exist "BTE%SWVER%.bin" goto :error
@del /Q "MJ6%SWVER%.bin"
make -s -j PROJECT_NAME=MJ6%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_MJWSD06MMC"
@if not exist "MJ6%SWVER%.bin" goto :error
@del /Q "CGDK2%SWVER%.bin"
make -s -j PROJECT_NAME=CGDK2%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_CGDK2"
@if not exist "CGDK2%SWVER%.bin" goto :error
@del /Q "CGG1%SWVER%.bin"
make -s -j PROJECT_NAME=CGG1%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_CGG1 -DDEVICE_CGG1_ver=0"
@if not exist "CGG1%SWVER%.bin" goto :error
@del /Q "CGG1M%SWVER%.bin"
make -s -j PROJECT_NAME=CGG1M%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_CGG1 -DDEVICE_CGG1_ver=2022"
@if not exist "CGG1M%SWVER%.bin" goto :error
@del /Q "MHO_C401%SWVER%.bin"
make -s -j PROJECT_NAME=MHO_C401%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_MHO_C401"
@if not exist "MHO_C401%SWVER%.bin" goto :error
@del /Q "MHO_C401N%SWVER%.bin"
make -s -j PROJECT_NAME=MHO_C401N%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_MHO_C401N"
@if not exist "MHO_C401N%SWVER%.bin" goto :error
@del /Q "MHO_C122%SWVER%.bin"
make -s -j PROJECT_NAME=MHO_C122%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_MHO_C122"
@if not exist "MHO_C122%SWVER%.bin" goto :error
@del /Q "TNK01%SWVER%.bin"
make -s -j PROJECT_NAME=TNK01%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_TNK01"
@if not exist "TNK01%SWVER%.bin" goto :error
@del /Q "TS0201%SWVER%.bin"
make -s -j PROJECT_NAME=TS0201%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_TS0201"
...
make -s -j PROJECT_NAME=TS0201S1%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_TS0201 -DUSE_SENSOR_MY18B20=1"
@if not exist "TS0201S1%SWVER%.bin" goto :error
@del /Q "TS0201S2%SWVER%.bin"
make -s -j PROJECT_NAME=TS0201S2%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_TS0201 -DUSE_SENSOR_MY18B20=2"
@if not exist "TS0201S2%SWVER%.bin" goto :error
@del /Q "TS0201E280%SWVER%.bin"
make -s -j PROJECT_NAME=TS0201E280%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_TS0201 -DUSE_SENSOR_BME280=1"
@if not exist "TS0201E280%SWVER%.bin" goto :error
@del /Q "TS0201B280%SWVER%.bin"
make -s -j PROJECT_NAME=TS0201B280%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_TS0201 -DUSE_SENSOR_BMP280=1"
@if not exist "TS0201B280%SWVER%.bin" goto :error
@del /Q "TH03Z%SWVER%.bin"
make -s -j PROJECT_NAME=TH03Z%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_TH03Z"
@if not exist "TH03Z%SWVER%.bin" goto :error
@del /Q "ZTH01%SWVER%.bin"
make -s -j PROJECT_NAME=ZTH01%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_ZTH01"
@if not exist "ZTH01%SWVER%.bin" goto :error
@del /Q "ZTH01S1%SWVER%.bin"
make -s -j PROJECT_NAME=ZTH01S1%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_ZTH01 -DUSE_SENSOR_MY18B20=1"
@if not exist "ZTH01S1%SWVER%.bin" goto :error
@del /Q "ZTH01S2%SWVER%.bin"
make -s -j PROJECT_NAME=ZTH01S2%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_ZTH01 -DUSE_SENSOR_MY18B20=2"
@if not exist "ZTH01S2%SWVER%.bin" goto :error
@del /Q "ZTH02%SWVER%.bin"
make -s -j PROJECT_NAME=ZTH02%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_ZTH02"
@if not exist "ZTH02%SWVER%.bin" goto :error
@del /Q "PLM1%SWVER%.bin"
make -s -j PROJECT_NAME=PLM1%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_PLM1"
@if not exist "PLM1%SWVER%.bin" goto :error
@del /Q "TB03F%SWVER%.bin"
make -s -j PROJECT_NAME=TB03F%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_TB03F"
@if not exist "TB03F%SWVER%.bin" goto :error
@del /Q "TH03%SWVER%.bin"
make -s -j PROJECT_NAME=TH03%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_ZTH03"
...
make -s -j PROJECT_NAME=LKTMZL02%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_LKTMZL02"
...
make -s -j PROJECT_NAME=ZTH05%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_ZTH05Z"
@if not exist "ZTH05%SWVER%.bin" goto :error
@del /Q "ZYZTH02%SWVER%.bin"
make -s -j PROJECT_NAME=ZYZTH02%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_ZYZTH02"
...
make -s -j PROJECT_NAME=ZYZTH02S1%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_ZYZTH02 -DUSE_SENSOR_MY18B20=1"
@if not exist "ZYZTH02S1%SWVER%.bin" goto :error
@del /Q "ZYZTH02S2%SWVER%.bin"
make -s -j PROJECT_NAME=ZYZTH02S2%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_ZYZTH02 -DUSE_SENSOR_MY18B20=2"
@if not exist "ZYZTH02S2%SWVER%.bin" goto :error
@del /Q "ZYZTH02P%SWVER%.bin"
make -s -j PROJECT_NAME=ZYZTH02P%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_ZYZTH01"
...
make -s -j PROJECT_NAME=ZG227Z%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_ZG_227Z"
...
make -s -j PROJECT_NAME=ZG303Z%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_ZG303Z"
...
make -s -j PROJECT_NAME=ZBTH01%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_ZBEACON_TH01"
...
make -s -j PROJECT_NAME=ZB_MC%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_ZB_MC"
@if not exist "ZB_MC%SWVER%.bin" goto :error
@del /Q "ZB2TH01%SWVER%.bin"
make -s -j PROJECT_NAME=ZB2TH01%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_ZBEACON2TH01"
...
make -s -j PROJECT_NAME=LYWSD02MMC%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_LYWSD02MMC"
@if not exist "LYWSD02MMC%SWVER%.bin" goto :error
@del /Q "ZG204ZV%SWVER%.bin"
make -s -j PROJECT_NAME=ZG204ZV%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_ZG204ZV"
@if not exist "ZG204ZV%SWVER%.bin" goto :error
@del /Q "TS0201W%SWVER%.bin"
make -s -j PROJECT_NAME=TS0201W%SWVER% PROJECT_DEF="-DDEVICE_TYPE=DEVICE_TS0201_WING"
@if not exist "TS0201W%SWVER%.bin" goto :error
python3 utils\zb_bin_ota.py TS0201W%SWVER%.bin zigbee_ota\TS0201WBLE%SWVER% -m0x1141 -i0xd3a3 -v0x19983001 -s"Tuya to BLE"
